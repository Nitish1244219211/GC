...
echo'<nav class="navbar bg-light navbar-light fixed-top">
...
$row=mysqli_fetch_assoc($res);
  ...
  $_SESSION['upic']= $pic;
      ...
      echo"<button class='btn btn-outline-light' type='button' data-bs-toggle='offcanvas' data-bs-target='#offcanvasWithBothOptions' aria-controls='offcanvasWithBothOptions' aria-expanded='false' aria-label='Toggle navigation'>";
if(isset($pic)){
