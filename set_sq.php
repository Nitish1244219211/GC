...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    }
  {
    ...
    $sql = "INSERT INTO `Security_Q` (`username`, `nickname`, `best_friend`, `father's_first_name`, `1st_school`, `fav_color`, `fav_fruit`, `fav_sweet`, `stage_name`, `pin_code`, `country`) VALUES ('$username ','$nickname','$best_friend','$father_first_name','$fst_school','$fav_color','$fav_fruit','$fav_sweet','$stage_name','$pin_code','$country')";
...
/*<script>
  ...
  */  }
    if($showError){
    echo ' <div class="alert alert-danger alert-dismissible fade show container col-md-12" id= "alert-info" role="alert">
...
<div class="container-fluid" id= "sq">
   <div class= "container my-4" style= "background-color: #F5F7FA; border-radius:40px; opacity:.83;">            <!--Forms........form-->
    <form action="set_sq.php"  method="post" style= "padding:30px;" class= "">
  <?php
  if(!$loggedin)
  {
